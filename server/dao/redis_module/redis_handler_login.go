...
func (this *RedisModule) loginIdKey() string {
	return "login_id_token"
}

func (this *RedisModule) loginTokenKey() string {
	return "login_token_id"
}

// IsAlreadyLogin 是否已登录
func (this *RedisModule) IsAlreadyLogin(token string) (bool, int64, error) {
...
func (this *RedisModule) DeleteTokenByUID(uid int64) error {
	c, err := redis_helper.GetClient(redis_helper.Default)
	if err != nil {
		return err
	}
...
//SaveLoginDB 保存登录信息
func (this *RedisModule) SaveLoginDB(uid int64, token string) error {
	c, err := redis_helper.GetClient(redis_helper.Default)
	if err != nil {
		return err
	}
